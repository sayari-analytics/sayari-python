...
class TraversalResponse(pydantic.BaseModel):
    ...
    TraversalResponse(min_depth=1, max_depth=4, relationships=[], countries=[], types=[], name="", watchlist=False, psa=True, offset=0, limit=1, partial_results=False, next=True, explored_count=9999999, data=[TraversalData(source="mGq1lpuqKssNWTjIokuPeA", target=EntityDetails(id="gm0zROLKqgX34AlFV4nw6w", label="HAL MANAGEMENT LIMITED", degree=1, entity_url="/v1/entity/gm0zROLKqgX34AlFV4nw6w", pep=False, psa_id="15753940187055", psa_count=1303, sanctioned=False, closed=False, type=Entities.COMPANY, identifiers=[], addresses=["HANOVER HOUSE, 14 HANOVER SQUARE, W1S 1HP"], countries=[Country.GBR], relationship_count={Relationships.REGISTERED_AGENT_OF: 1}, source_count={"ecdfb3f2ecc8c3797e77d5795a8066ef": SourceCountInfo(count=2, label="UK Corporate Registry", )}, risk={Risk.BASEL_AML: RiskData(metadata={"country": ["GBR"]}, level=RiskLevel.RELEVANT, ), Risk.CPI_SCORE: RiskData(metadata={"country": ["GBR"]}, level=RiskLevel.RELEVANT, )}, user_attribute_count={}, user_record_count=0, user_related_entities_count=0, user_relationship_count={}, related_entities_count=1, attribute_count={Attributes.ADDRESS: 1, Attributes.NAME: 1, Attributes.COUNTRY: 2}, ), path=[TraversalPath(field="has_registered_agent", entity=EntityDetails(id="gm0zROLKqgX34AlFV4nw6w", label="HAL MANAGEMENT LIMITED", degree=1, entity_url="/v1/entity/gm0zROLKqgX34AlFV4nw6w", pep=False, psa_id="15753940187055", psa_count=1303, sanctioned=False, closed=False, type=Entities.COMPANY, identifiers=[], addresses=["HANOVER HOUSE, 14 HANOVER SQUARE, W1S 1HP"], countries=[Country.GBR], relationship_count={Relationships.REGISTERED_AGENT_OF: 1}, source_count={"ecdfb3f2ecc8c3797e77d5795a8066ef": SourceCountInfo(count=2, label="UK Corporate Registry", )}, risk={Risk.BASEL_AML: RiskData(metadata={"country": ["GBR"]}, level=RiskLevel.RELEVANT, ), Risk.CPI_SCORE: RiskData(metadata={"country": ["GBR"]}, level=RiskLevel.RELEVANT, )}, user_attribute_count={}, user_record_count=0, user_related_entities_count=0, user_relationship_count={}, related_entities_count=1, attribute_count={Attributes.ADDRESS: 1, Attributes.NAME: 1, Attributes.COUNTRY: 2}, ), relationships={Relationships.HAS_REGISTERED_AGENT: TraversalRelationshipData(values=[RelationshipInfo(record="ecdfb3f2ecc8c3797e77d5795a8066ef/06517802/1682985600000", from_date="2008-02-28", to_date="2008-07-10", acquisition_date="2023-05-02", publication_date="2023-05-02", former=True, attributes={Attributes.POSITION: [{"value": "Secretary"}]}, ), RelationshipInfo(record="ecdfb3f2ecc8c3797e77d5795a8066ef/06517802/1686009600000", from_date="2008-02-28", to_date="2008-07-10", acquisition_date="2023-06-06", publication_date="2023-06-06", former=True, attributes={}, )], former=True, start_date="2008-02-28", end_date="2008-07-10", last_observed="2008-07-10", )}, )], )], )
    """
