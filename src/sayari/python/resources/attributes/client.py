...
class AttributesClient:
    ...
    def post_attribute(
        ...
        ---
        from sayari-analytics import AddAttribute
        ...
        client.attributes.post_attribute(request=AddAttribute(entity="zq04axX2dLn9tE6W6Q8Qhg", type="address", value={"street1": "1600 Pennsylvania Avenue NW", "city": "Washington DC", "state": "Washington DC", "postalCode": "20500", "country": "US"}, to_date="2024-04-30", from_date="2024-01-01", date="2024-02-15", ), )
        """
        _response = self._client_wrapper.httpx_client.request(
            "POST",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "v1/attribute"),
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(AttributeResponse, _response.json())  # type: ignore
    ...
    def patch_attribute(
        ...
        client = SayariAnalyticsApi(client_name="YOUR_CLIENT_NAME", token="YOUR_TOKEN", )
        client.attributes.patch_attribute(attribute_id="enEwNGF4WDJkTG45dEU2VzZROFFoZ3xhZGRyZXNzfDBwbEVCMHxVNzhzN21yOUVFTThIZ3pwREM3UDFB", request=UpdateAttribute(value={"street1": "1600 Pennsylvania Avenue NW", "city": "Washington DC", "state": "Washington DC", "postalCode": "20500", "country": "US"}, to_date="2024-04-30", from_date="2024-01-01", date="2024-02-15", ), )
        """
        _response = self._client_wrapper.httpx_client.request(
            "PATCH",
    ...
    def delete_attribute(
        ...
        client = SayariAnalyticsApi(client_name="YOUR_CLIENT_NAME", token="YOUR_TOKEN", )
        client.attributes.delete_attribute(attribute_id="enEwNGF4WDJkTG45dEU2VzZROFFoZ3xhZGRyZXNzfDBwbEVCMHxVNzhzN21yOUVFTThIZ3pwREM3UDFB", )
        """
        _response = self._client_wrapper.httpx_client.request(
            "DELETE",
            urllib.parse.urljoin(
...
class AsyncAttributesClient:
    ...
    async def post_attribute(
        ...
        await client.attributes.post_attribute(request=AddAttribute(entity="zq04axX2dLn9tE6W6Q8Qhg", type="address", value={"street1": "1600 Pennsylvania Avenue NW", "city": "Washington DC", "state": "Washington DC", "postalCode": "20500", "country": "US"}, to_date="2024-04-30", from_date="2024-01-01", date="2024-02-15", ), )
        """
    ...
    async def delete_attribute(
        ...
        client = AsyncSayariAnalyticsApi(client_name="YOUR_CLIENT_NAME", token="YOUR_TOKEN", )
        await client.attributes.delete_attribute(attribute_id="enEwNGF4WDJkTG45dEU2VzZROFFoZ3xhZGRyZXNzfDBwbEVCMHxVNzhzN21yOUVFTThIZ3pwREM3UDFB", )
        """
        _response = await self._client_wrapper.httpx_client.request(
            "DELETE",
            urllib.parse.urljoin(
