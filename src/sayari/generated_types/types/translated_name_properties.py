...
class TranslatedNameProperties(pydantic_v1.BaseModel):
    context: typing.Optional[TranslationContext] = pydantic_v1.Field(default=None)
    """
    ...
    original: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The original name
    """
