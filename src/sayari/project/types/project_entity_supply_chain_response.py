...
import typing
from ...supply_chain.types.trade_traversal_path import TradeTraversalPath
from ...core.pydantic_utilities import IS_PYDANTIC_V2
import pydantic


class ProjectEntitySupplyChainResponse(UniversalBaseModel):
    """
    Examples
    --------
    from sayari.project import ProjectEntitySupplyChainResponse
